...
static const uint8_t tile_loading_bar[8]    = { 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111, 0b11111111 }; 
static const uint8_t tile_loading_part_0[8] = { 0b00000000, 0b10000011, 0b10000100, 0b10000100, 0b10000100, 0b10000100, 0b11110011, 0b00000000 };
static const uint8_t tile_loading_part_1[8] = { 0b00000000, 0b10001110, 0b01010001, 0b01010001, 0b01011111, 0b01010001, 0b10010001, 0b00000000 };
static const uint8_t tile_loading_part_2[8] = { 0b00000000, 0b01111001, 0b01000100, 0b01000100, 0b01000100, 0b01000100, 0b01111001, 0b00000000 };
static const uint8_t tile_loading_part_3[8] = { 0b00000000, 0b11010001, 0b10011001, 0b10010101, 0b10010011, 0b10010001, 0b11010001, 0b00000000 };
static const uint8_t tile_loading_part_4[8] = { 0b00000000, 0b00111100, 0b01000000, 0b01011100, 0b01000100, 0b01000100, 0b00111100, 0b00000000 };

uint8_t loading_tile_x = 10;
uint8_t loading_tile_y = 11;
...
void loading_init(uint8_t tile_x, uint8_t tile_y) {
    ...
    loading_tile_x = tile_x;
    loading_tile_y = tile_y;
    ...
    int pos = loading_tile_x + loading_tile_y * 32;
